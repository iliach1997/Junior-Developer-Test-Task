...
require_once realpath("../app/vendor/autoload.php");

$errors = include_once '../app/vendor/views/product/Errors/errors.php';
...
<div class="div_box">
  <h1>Product ADD</h1>
  <div>
    <button id="submit_id" name="submit" class="button_save">save</button>
    <button name="but" id="cancel_btn" class="button_cancele">CANCELL</button>
  </div>
</div>
...
<div class="form_div">
  <div class="div_input">
    <div class="div_child">#SKU</div>
    <div><input class="input_sku" id="sku_input" type="text" placeholder="#sku" name="sku" value="<?php if (!empty($sku)) {
                                                                                                    echo $sku;
                                                                                                  } ?>">
    </div>
  </div>
  ...
  <div class="div_input">
    <div class="div_child">#Name</div>
    <div><input class="input_sku" id="name_input" type="text" placeholder="#name" name="name" value="<?php if (!empty($name)) {
                                                                                                        echo $name;
                                                                                                      } ?>">
    </div>
  </div>
  ...
  <!-- div price -->
  <div class="div_input">
    <div class="div_child">#Prise ($)</div>
    <div><input class="input_sku" type="text" id="price_input" placeholder="#prise" name="price" value="<?php if (!empty($price)) {
                                                                                                          echo $price;
                                                                                                        } ?>"></div>
  </div>
...
<div>
  ...
  <div class="dvd_none" id="div_dvd">
    <div class="div_text">Size (MB)</div>
    <div class="farnitur_errors"><input id="size_id" name="size" placeholder="#size" value="<?php if (!empty($size)) {
                                                                                              echo $size;
                                                                                            } ?>">
  ...
  <div class="book_none" id="div_book">
    <div class="div_text">Wiegth (KG)</div>
    <div class="farnitur_errors"><input id="weigth_id" name="weigth" placeholder="#weigth" value="<?php if (!empty($weigth)) {
                                                                                                    echo $weigth;
                                                                                                  } ?>">
  ...
  <div class="furniture_none" id="div_furniture">
    ...
    <div class="div_furniture">
      ...
      <div><input id="heigth_id" name="heigth" placeholder="#heigth" value="<?php if (!empty($heigth)) {
                                                                              echo $heigth;
                                                                            } ?>">
    ...
    <div class="div_furniture">
      ...
      <div><input id="width_id" name="width" placeholder="#width" value="<?php if (!empty($width)) {
                                                                            echo $width;
                                                                          } ?>">
    ...
    <div class="div_furniture">
      ...
      <div><input id="length_id" name="length" placeholder="#length" value="<?php if (!empty($length)) {
                                                                              echo $length;
                                                                            } ?>">
